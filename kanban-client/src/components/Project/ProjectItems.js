...
import { getAllProject } from '../../store/actions';
      ...
      <div>
        ...
        >
          ...
          <DialogActions>
            ...
            <Button onClick={() => this._handleClose(id)} variant="contained" color="secondary">Delete</Button>
          </DialogActions>
        </Dialog>
      </div>
    );
